...
class SendOutDeliveryScreen extends StatefulWidget {
  const SendOutDeliveryScreen({Key? key}) : super(key: key);

  @override
  State<SendOutDeliveryScreen> createState() => _SendOutDeliveryScreenState();
}

class _SendOutDeliveryScreenState extends State<SendOutDeliveryScreen> {
